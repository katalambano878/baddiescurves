...
const defaultSettings: SiteSettings = {
    site_name: "BADDIECURVES",
    site_tagline: 'Waist trainers, shapewear, post-op & activewear. Athleisure for every curve.',
    site_logo: '/logo.png?v=4',
    contact_email: 'baddiecurves@gmail.com',
    contact_phone: '054 927 8135',
    contact_address: 'Union NJ',
    social_facebook: '',
    social_instagram: 'https://www.instagram.com/Baddiecurves',
    social_twitter: '',
    social_tiktok: 'https://www.tiktok.com/@Baddiecurves1',
    social_snapchat: '',
    social_youtube: '',
